...
export const invoice1: IInvoice = {
  ...
  paid_date: '', comment: '', copy_comments: {}, created_by: 'admin1', updated_by: 'admin1', created_by_name: 'Админ', updated_by_name: 'Админ',
  source_paid_amount: 0, source_paid_date: '',
};
export const invoice2: IInvoice = {
  ...
  paid_date: '2026-06-02', comment: '', copy_comments: {}, created_by: 'admin1', updated_by: 'admin1', created_by_name: 'Админ', updated_by_name: 'Админ',
  source_paid_amount: 30000, source_paid_date: '2026-06-02',
};
export const invoice3: IInvoice = {
  ...
  paid_date: '', comment: 'Срочно', copy_comments: {}, created_by: 'admin1', updated_by: 'admin1', created_by_name: 'Админ', updated_by_name: 'Админ',
  source_paid_amount: 0, source_paid_date: '',
};
